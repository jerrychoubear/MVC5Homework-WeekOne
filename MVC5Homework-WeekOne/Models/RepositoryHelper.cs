namespace MVC5Homework_WeekOne.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶聯絡人與銀行帳戶數量一覽表Repository Get客戶聯絡人與銀行帳戶數量一覽表Repository()
		{
			var repository = new 客戶聯絡人與銀行帳戶數量一覽表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶聯絡人與銀行帳戶數量一覽表Repository Get客戶聯絡人與銀行帳戶數量一覽表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶聯絡人與銀行帳戶數量一覽表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
